...
function fixEslint() {
  const issues = [
    ...
    { file: 'xpress-app/src/Contexts/NetworkStatusContext.jsx', search: /catch \(e\) \{/, replace: 'catch () {' },
    ...
    { file: 'xpress-app/tailwind.config.js', search: /import forms from '@tailwindcss\/forms'/, replace: "" },
    { file: 'xpress-app/tailwind.config.js', search: /import typography from '@tailwindcss\/typography'/, replace: "" },
  ];
