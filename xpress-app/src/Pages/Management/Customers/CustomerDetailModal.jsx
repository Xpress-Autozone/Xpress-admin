...
import { X, User, MapPin, Mail, Phone, Calendar, ShoppingBag, Edit, ShieldAlert, MessageSquare, Save } from 'lucide-react';
        ...
        <div className="overflow-y-auto p-6 flex-1 thin-scrollbar">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6 text-left">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    {customer.phone || '+233 XX XXX XXXX'}
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    Joined: {customer.createdAt || 'Jan 2026'}
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-900 mb-3 uppercase tracking-wider">Account Settings</h3>
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 flex flex-col gap-2">
                   <button 
                     ...
                     className="text-sm font-bold text-green-600 hover:underline flex items-center gap-2 text-left"
                   >
                     <Save className="w-4 h-4" /> Save Profile Tags
                   </button>
                   <button className="text-sm font-bold text-red-600 hover:underline flex items-center gap-2 text-left">
                   ...
                   {dummyOrders.map(order => (
                     <div key={order.id} className="p-3 border border-gray-100 rounded-xl hover:border-yellow-300 transition-colors bg-white">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-[10px] font-bold text-green-700 bg-green-50 px-2 py-0.5 rounded-full">{order.status}</span>
                        </div>
