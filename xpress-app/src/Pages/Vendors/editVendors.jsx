...
function EditVendor() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (result.data.photoURL) {
                        setProfileImage({ url: result.data.photoURL });
                    }
                } else {
    ...
    const handleSubmit = async () => {
        if (!formData.displayName || !formData.email || !formData.phoneNumber || !formData.location) {
            setAlert({
                isOpen: true,
                type: "warning",
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="space-y-8 space-x-18">
                            ...
                            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                                ...
                                >
                                    {isSaving && <LoadingSpinner size="sm" color="gray" />}
                                    <span>{isSaving ? "Saving..." : "Update Vendor"}</span>
                                </button>
                            </div>
                        </div>
                    </div>
